...
export default function Hero() {
  const words = [
    "E-commerce stores, landing pages, and everything in between — tailored just for your business.",
    "Fast, modern, and mobile-friendly websites designed to impress and perform.",
    "From idea to launch — we handle design, development, and deployment.",
    "Build your brand online with stunning websites that drive results."
  ];
...
const profile = {
    ...
    technologies: [
        ...
        'Tailwind CSS', 'TypeScript', 'Firebase', 'AWS'
    ],
    values: {
    ...
    yearsInBusiness: 2,
    readyToWorkWith: function() {
        return this.yearsInBusiness >= 1;
    }
};`);
          ...
          >
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="inline-flex items-center gap-2 sm:gap-3 px-4 sm:px-6 py-2 sm:py-3 rounded-xl sm:rounded-2xl bg-gradient-to-r from-blue-500/10 to-teal-500/10 border border-blue-500/20 mb-6 sm:mb-8 backdrop-blur-sm animate__animated animate__fadeInUp animate__delay-1s">
                ...
                <span>
                  <FlipWords
                    className={"text-lg sm:text-l text-blue-500 font-medium"}
                    words={words}
                  />
                </span>
              </div>
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                ...
                Custom Websites That Don’t Just Look Good — They Convert.</p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                >
                  <span className="block w-full px-6 sm:px-8 py-3 sm:py-4 rounded-[11px] bg-green-900 border border-gray-700/50 transition-all duration-300 group-hover:bg-gradient-to-r group-hover:from-gray-800 group-hover:to-gray-700">
              ...
              <div className="hidden lg:block absolute left-[5.5rem] top-[2.3rem] animate-float-slow">
                <div className="px-4 py-2 rounded-lg bg-purple-500/10 backdrop-blur-sm border border-purple-500/20 text-purple-400">
                  <i className="fas fa-wand-magic-sparkles"></i>&nbsp;&nbsp;Impact Built
                </div>
              </div>
              <div className="hidden lg:block absolute right-10 top-20 animate-float">
                <div className="px-4 py-2 rounded-lg bg-blue-500/10 backdrop-blur-sm border border-blue-500/20 text-blue-400">
                  <i className="fas fa-code"></i>&nbsp;&nbsp;Vision Engineered
